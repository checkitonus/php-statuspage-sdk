...
use Iterator;
use CheckItOnUs\StatusPage\Request\WebRequest;
...
class PagedResponse implements Iterator
{
     ...
     *
     * @param      \CheckItOnUs\StatusPage\Request\WebRequest  $webRequest  The web request
    ...
    private function sendRequest()
    {
        ...
        return $this->data = $this->_pagedData[$this->_page] = is_array($response) ? collect($response) : $response;
    }
}